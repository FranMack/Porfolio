    ...
    >
      <div className="w-[100%]  h-auto flex  justify-center items-center xs:flex-col lg:flex-row">
        <div className="w-[50%]  flex justify-center items-center  flex-col ">
          <h1 className=" whitespace-nowrap  xl:text-[3rem] lg:text-[2.5rem] sm:text-[2.2rem] xs:text-[1.6rem] mt-[5%] ">
          ...
          <h2 className="textMotion  xl:text-[3rem] lg:text-[2.5rem] sm:text-[2.2rem] xs:text-[1.6rem] ">{`Full-Stack Developer </>`}</h2>
        </div>
      ...
      <div className="saludoReveal3  flex flex-col items-center">
        <h2 className=" xl:text-[2.5rem] lg:text-[2.2rem] sm:text-[2rem] xs:text-[1.5rem] ">
