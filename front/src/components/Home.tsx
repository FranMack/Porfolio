...
function Home({ referencia }: HomeProps) {
  return (
    <section
      ref={referencia}
      className="w-full h-[100vh] mx-auto flex justify-center text-center items-center pt-[12vh]"
    >
      <div className="w-1/2 h-[70%] flex flex-col justify-center items-center colum">
        ...
        <h2 className="text-[2.5rem] font-semibold">Bienvenidos a mi porfolio</h2>
      </div>
    </section>
  );
}
